...
- `show_image`
- `rand`
- `sdl2` (This requires installation of the `libsdl2-dev` Debian package)
...
- [Tank - from the CHIP-8 games pack](https://www.zophar.net/pdroms/chip8/chip-8-games-pack.html)
- [Space Invaders - from the CHIP-8 games pack](https://www.zophar.net/pdroms/chip8/chip-8-games-pack.html)
